...
import SearchConditionResultBar from '../searchConditionBar/index';
import { SearchConditionItem } from '../searchConditionBar/types';
...
const SearchBar = (props: SearchProps) => {
  ...
  return (
    <div className={'ysc_ux_search_bar'} ref={containerRef}>
      <Form
        initialValues={value}
        form={form}
      ...
      {(tabItems || tabExtra) && (
        <div
          className={'ysc_ux_search_tabs_bar'}
