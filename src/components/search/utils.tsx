...
import { Input, InputNumber, Select, TimePicker, DatePicker, Button } from 'antd';
import {InputNumberRange} from '../inputNumberRange';
import ChinaPcasSelector, { PcasSelectorType } from '../chinaPcasSelector';
...
const renderItem = (fieldItem: FieldItem) => {
  ...
  switch (type) {
    case 'text':
      ...
      break;
    case 'number':
      item = <InputNumber {...fieldProps} placeholder={placeholder || "请输入"} style={{ width: '100%' }} />;
      break;
    case 'provincePicker':
      item = (
        <ChinaPcasSelector
    ...
    case 'streetPicker':
      ...
      break;
    case 'numberRange':
      // item = <InputNumberRange {...fieldProps} value={[1,2]} placeholder="请输入" />;
      item = <></>;
      break;
    case 'select':
      item = (
